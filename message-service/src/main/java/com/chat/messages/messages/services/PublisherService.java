...
import com.chat.messages.messages.dto.MsgStatRespDto;
...
public class PublisherService {
    ...
    public void sendToMsgStatResponse(MsgSendRespDto<MsgStatRespDto, MsgStatRespDto> msgSendRespDto){
        rabbitTemplate.convertAndSend(RabbitConfig.MESSAGE_EXCHANGE, RabbitConfig.MESSAGE_STATUS_RESPONSE_QUEUE, msgSendRespDto);
        System.out.println("sending from message service: "+msgSendRespDto.toString());
    }
